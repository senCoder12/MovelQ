...
public class ActionDraft {
    ...
    @Column(name = "recipient_json", nullable = false, updatable = false, columnDefinition = "CLOB")
    ...
    @Column(name = "body", nullable = false, updatable = false, columnDefinition = "CLOB")
    private String body;

    @Column(name = "facts_cited_json", nullable = false, updatable = false, columnDefinition = "CLOB")
    private String factsCitedJson;

    @Column(name = "preview_json", nullable = false, updatable = false, columnDefinition = "CLOB")
    private String previewJson;

    @Column(name = "rationale", updatable = false, columnDefinition = "CLOB")
