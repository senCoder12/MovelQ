...
public class ReportDispatch {
    ...
    @Column(name = "recipients_json", nullable = false, updatable = false, columnDefinition = "CLOB")
    private String recipientsJson;

    @Column(name = "subject", nullable = false, updatable = false, length = 500)
    private String subject;

    @Column(name = "body_html", nullable = false, updatable = false, columnDefinition = "CLOB")
    private String bodyHtml;

    @Column(name = "body_text", nullable = false, updatable = false, columnDefinition = "CLOB")
